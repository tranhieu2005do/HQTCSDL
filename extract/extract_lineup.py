...
def load_fixture_ids():
    ...
    events_file = Path("output/lineups.json")
...
def extract_lineups() -> None:
    ...
    print(
        f"Starting lineups extraction for "
    ...
    for index, fixture_id in enumerate(fixture_ids[:max_requests]):
        ...
        if response.get("errors"):
            ...
            print(
                f"Captured lineups for fixture "
                f"{fixture_id}"
            )
